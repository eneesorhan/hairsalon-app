...
export default function AdminAppointmentsPage() {
  ...
  const handleDeleteAppointment = async (id: string) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Silineme başarısız');
      }
  ...
  const handleAddWalkIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Walk-in eklenemedi');
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap transition-all ${
                    statusFilter === status
                      ...
                      : 'bg-white dark:bg-slate-800 border-2 border-purple-200 dark:border-purple-900/50 text-gray-700 dark:text-gray-300 hover:border-purple-600'
                  }`}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setWalkInData({ ...walkInData, date: e.target.value })
                    }
                    required
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setWalkInData({ ...walkInData, startTime: e.target.value })
                    }
                    required
                    className="w-full p-3 border-2 border-purple-200 dark:border-purple-900/50 rounded-lg focus:border-purple-600 focus:outline-none dark:bg-slate-700 dark:text-white"
                  />
                      ...
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-all"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded hover:bg-red-200 dark:hover:bg-red-900/50 transition-all"
                          >
            ...
            <div className="p-8 text-center">
              <p className="text-gray-600 dark:text-gray-400">
                {searchQuery || statusFilter !== 'all'
                  ? 'Arama kriterlerine göre randevu bulunamadı'
                  : 'Henüz randevu yok'}
              </p>
            </div>
          )}
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white rounded-lg p-6 shadow-lg">
            <p className="text-sm opacity-90 mb-2">Bekleyen</p>
            <p className="text-4xl font-bold">
              {appointments.filter((a) => a.status === 'pending').length}
            </p>
          </div>
          <div className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-lg p-6 shadow-lg">
            <p className="text-sm opacity-90 mb-2">Onaylı</p>
            <p className="text-4xl font-bold">
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-lg p-6 shadow-lg">
            ...
            <p className="text-3xl font-bold">
              £{appointments.reduce((sum, a) => sum + a.totalPrice, 0)}
            </p>
          </div>
        </div>
      </div>
      ...
      {showModal && selectedAppointment && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-lg max-w-2xl w-full p-8 max-h-96 overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    <strong>Ad:</strong> {selectedAppointment.customerName}
                  </p>
              ...
              <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    <strong>Hizmet:</strong> {selectedAppointment.serviceId.name}
                  </p>
                  <p>
                    <strong>Tarih:</strong> {selectedAppointment.date}
                  </p>
                  <p>
                    <strong>Saat:</strong> {selectedAppointment.startTime} -{' '}
                    {selectedAppointment.endTime}
                  </p>
                  <p>
                    <strong>Fiyat:</strong> £{selectedAppointment.totalPrice}
                  </p>
                  <p className="flex items-center gap-2">
            ...
            <div className="mt-6 flex gap-2">
              <button
                ...
                className="flex-1 px-4 py-2 bg-gray-300 dark:bg-gray-700 text-gray-800 dark:text-white rounded-lg font-semibold hover:bg-gray-400 dark:hover:bg-gray-600 transition-all"
              >
                Kapat
              </button>
              <button
